...
Use groups for distinct phases: **Prepping**, **Researching**, **Planning**, **Implementing**, **Verifying**. Rules: one group per phase, no nesting, keep names to 1-3 words. Both `</group:Name>` and `</group>` work as closing tags.
